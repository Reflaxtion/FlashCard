  ...
  const SideBtnData = [
    {
      ...
      btn_icon: <CiShare2 className="text-600 scolor" />,
      btn_text: "Share",
      btn_fn: () => {
        setToggleModal("grid");
      },
    },
    {
      ...
      btn_icon: <BsDownload className="text-600 scolor" />,
      btn_text: "Download",
      btn_fn: downloadPDF,
    },
    {
      btn_id: 3,
      btn_title: "print",
      btn_icon: <BsPrinter className="text-600 scolor" />,
      btn_text: "Print",
              ...
              ({ btn_icon, btn_text, btn_title, btn_id, btn_fn }) => (
                <li key={btn_id}>
                  <Button
                    ...
                    btnclass="flex items-center gap-2 bg-white rounded-md w-full shadow-sm transition-all px-6 py-2 bcolor"
                  />
                </li>
              )
            )}
